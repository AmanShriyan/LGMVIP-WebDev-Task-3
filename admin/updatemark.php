    ...
    <header>
      ...
      <div class="main-content-header">
        ...
        <table class="table1">
            ...
            <tr align="left">
            <th align="left">Enter Class : </th>
            <td align="left"><input type="text" name="class" class="box"/></td>
      </tr>
      <tr>
            <th align="left">Student Rollno : </th>
            <td align="left"><input type="text" name="rollno" class="box"/></td>
            </tr>
            </table>
