    ...
    <header>
      ...
      <div class="main-content-header">
          ...
          <form method="post" action="update_mark_data.php">
              <div class="display">
                <h5> 
                    Student Name:   <span class="span"><?php echo $row['u_name']; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    Student Class:  <span class="span"><?php echo $row['u_class']; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    Student Rollno: <span class="span"><?php echo $row['u_rollno']; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </h5>
            </div>
                  
          <table class="table1">
              <span> <h4 class="h_3"> FIRST SEM </h4></span>
             <tr>
          ...
          <span> <h4 class="h3">SECOND SEM</h4> </span>
         <table class="table4">
             <tr>
                <th>Hindi</th>   <th> English </th> <th>Math</th>
             </tr>
