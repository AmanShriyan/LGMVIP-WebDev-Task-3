    ...
    <header>
      ...
      <div class="main-content-header">
        <form method="post" action="result.php">
          ...
          <table class="table2">
              <tr>
               <th style="color:red">Suject</th><th style="color:red">Half Yealy Exam (Score) </th><th style="color:red">Annual Exam (Score)</th><th style="color:red">Total</th><th style="color:red">Max. Marks</th>
              </tr>
              <tr>
          ...
          <div class="line">
             ...
             <h1>You Are Pass with <span class="colorchange1"><?php $per=($all*100)/1000;
                        if($all<=500) 
                        {
                            echo "Fail";
                        }
                      ...
                      ?></span></h1>
                        <div class="mar">
                            <marquee scrollamount="5">Your Result is Declared. Kindly contact your respectve teacher in case of any queries....</marquee>
                        </div>
       </form>
      </div>
    </header>
